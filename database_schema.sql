...
CREATE DATABASE IF NOT EXISTS `klinik_jati_asih_medika` 
DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

USE `klinik_jati_asih_medika`;
...
-- ------------------------------------------------------------
-- 2. TABEL MASTER POLI / PELAYANAN MEDIS
-- ------------------------------------------------------------
CREATE TABLE `poli` (
  `id` INT AUTO_INCREMENT PRIMARY KEY,
...
-- ------------------------------------------------------------
-- 4. TABEL TRANSAKSI KUNJUNGAN PASIEN
-- ------------------------------------------------------------
...
-- ============================================================
-- SEED DATA AWAL (MASTER POLI & DOKTER)
-- ============================================================
...
INSERT INTO `kunjungan` (`id`, `no_registrasi`, `tanggal_kunjungan`, `waktu_kunjungan`, `pasien_id`, `status_pasien`, `poli_id`, `dokter_id`, `penjamin`, `no_kartu_penjamin`, `tindakan`, `catatan`) VALUES
